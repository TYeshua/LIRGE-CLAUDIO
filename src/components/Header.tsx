          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button
                  onClick={toggleLanguage}
                  className="mt-3 w-full flex items-center justify-center gap-2 p-2 rounded-md bg-lirge-cyan text-white dark:bg-white dark:text-lirge-darker text-sm font-medium shadow-md transition-all"
                >
                  {i18n.language === "pt" ? "EN" : "PT"}
                </button>
              </div>
